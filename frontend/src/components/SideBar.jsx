  ...
  return (
    <div className={`fixed top-0 ${left} sm:left-0 w-64 h-screen bg-gray-800 z-10 transition-all`}>
      <div className='bg-white p-4'>
        ...
        <i onClick={closeSideBar} className="bi bi-x-lg sm:hidden absolute top-4 right-4 block cursor-pointer text-lg"></i>
      </div>
      <ul className='mt-4 '>
        ...
        className='text-base capitalize' to={"/dashboard/orders"}>orders</Link>
        </li>
        <li className='px-4 py-3 transition-all cursor-pointer text-white flex items-center hover:bg-gray-600'>
